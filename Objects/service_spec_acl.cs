...
namespace DataLine.dfdsfdbfghh
{
    ...
    public class service_spec_acl : ICSSoft.STORMNET.DataObject
    {
        ...
        private DataLine.dfdsfdbfghh.grp fgroup_id;
        ...
        [PropertyStorage(new string[] {
                "group_id"})]
        [NotNull()]
        public virtual DataLine.dfdsfdbfghh.grp group_id
        {
            get
            {
                ...
                DataLine.dfdsfdbfghh.grp result = this.fgroup_id;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View service_spec_aclE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("service_spec_aclE", typeof(DataLine.dfdsfdbfghh.service_spec_acl));
                }
            }
            ...
            public static ICSSoft.STORMNET.View service_spec_aclL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("service_spec_aclL", typeof(DataLine.dfdsfdbfghh.service_spec_acl));
                }
            }
        }
    }
