...
namespace DataLine.dfdsfdbfghh
{
    ...
    public class service_spec : ICSSoft.STORMNET.DataObject
    {
        ...
        private DataLine.dfdsfdbfghh.catalog fcatalog_key;
        
        private DataLine.dfdsfdbfghh.service_spec fparent_id;
        ...
        [PropertyStorage(new string[] {
                "catalog_key"})]
        public virtual DataLine.dfdsfdbfghh.catalog catalog_key
        {
            get
            {
                ...
                DataLine.dfdsfdbfghh.catalog result = this.fcatalog_key;
        ...
        [NotNull()]
        public virtual DataLine.dfdsfdbfghh.service_spec parent_id
        {
            get
            {
                ...
                DataLine.dfdsfdbfghh.service_spec result = this.fparent_id;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View service_specE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("service_specE", typeof(DataLine.dfdsfdbfghh.service_spec));
                }
            }
            ...
            public static ICSSoft.STORMNET.View service_specL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("service_specL", typeof(DataLine.dfdsfdbfghh.service_spec));
                }
            }
        }
    }
